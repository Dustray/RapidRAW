...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/organization-C75z74_V.mjs
/**
...
function useOAuthConsent(params) {
	useAssertWrappedByClerkProvider$1(HOOK_NAME$2);
...
//#endregion
//#region node_modules/@clerk/react/dist/chunk-GRZDFHDQ.mjs
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/proxy-uGxHFpDF.mjs
/**
*
*/
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/versionSelector-B60ghK2y.mjs
/**
...
//#endregion
//#region node_modules/@clerk/react/dist/chunk-TXELXGQD.mjs
...
function computeReactVersionCompatibility() {
	try {
		return isVersionCompatible("19.2.6", define_CLERK_UI_SUPPORTED_REACT_BOUNDS_default);
	} catch {
		return false;
	}
}
	...
	constructor(options) {
		...
		*/
		...
		this.__experimental_mountConfigureSSO = (node, props) => {
			if (this.clerkjs && this.loaded) this.clerkjs.__experimental_mountConfigureSSO(node, props);
			else this.premountConfigureSSONodes.set(node, props);
		};
		this.__experimental_unmountConfigureSSO = (node) => {
			if (this.clerkjs && this.loaded) this.clerkjs.__experimental_unmountConfigureSSO(node);
...
if (globalThis.__clerkSharedModules) {
	...
	if (existingVersion && existingVersion !== "19.2.6") console.warn(`[@clerk/ui/register] React version mismatch detected. Already registered: ${existingVersion}, current import: 19.2.6. This may cause issues with the shared @clerk/ui variant.`);
