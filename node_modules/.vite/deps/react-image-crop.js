...
var N = 0;
var x = class x extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		...
		m(this, "onHandlerKeyDown", (e, n) => {
			...
			const C = (navigator.platform.match("Mac") ? e.metaKey : e.ctrlKey) ? x.nudgeStepLarge : e.shiftKey ? x.nudgeStepMedium : x.nudgeStep, R = k(I(D(d, p.width, p.height), e.key, C, n), t, n, p.width, p.height, o, w, i, s);
			if (!X(d, R)) {
	...
	renderCropSelection() {
		...
		if (o) return /* @__PURE__ */ import_react.createElement("div", {
			...
			role: "group"
		}, !n && !t && /* @__PURE__ */ import_react.createElement("div", {
			...
			role: "button"
		})), d && /* @__PURE__ */ import_react.createElement("div", {
			className: "ReactCrop__selection-addon",
			onPointerDown: (i) => i.stopPropagation()
		}, d(this.state)), r && /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("div", { className: "ReactCrop__rule-of-thirds-hz" }), /* @__PURE__ */ import_react.createElement("div", { className: "ReactCrop__rule-of-thirds-vt" })));
	}
	makePixelCrop(e) {
		return D({
			...E,
	...
	render() {
		...
		return /* @__PURE__ */ import_react.createElement("div", {
		...
		}, n), r ? /* @__PURE__ */ import_react.createElement("svg", {
			...
			height: "100%",
			fill: "white"
		}), t ? /* @__PURE__ */ import_react.createElement("ellipse", {
...
m(x, "xOrds", ["e", "w"]), m(x, "yOrds", ["n", "s"]), m(x, "xyOrds", [
	"nw",
	"ne",
	"se",
	"sw"
]), m(x, "nudgeStep", 1), m(x, "nudgeStepMedium", 10), m(x, "nudgeStepLarge", 100), m(x, "defaultProps", { ariaLabels: {
...
var S = x;
//#endregion
export { S as Component, S as ReactCrop, S as default, X as areCropsEqual, L as centerCrop, b as clamp, H as cls, k as containCrop, v as convertToPercentCrop, D as convertToPixelCrop, E as defaultCrop, B as makeAspectCrop, I as nudgeCrop };
