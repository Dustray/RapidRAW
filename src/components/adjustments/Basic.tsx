...
const ToneMapperSwitch = ({
  ...
  const toneMapperOptions = [
    { id: 'basic', label: t('editor.adjustments.basic.tonemappers.basic'), title: t('editor.adjustments.basic.tonemappers.basicTitle') },
    { id: 'agx', label: t('editor.adjustments.basic.tonemappers.agx'), title: t('editor.adjustments.basic.tonemappers.agxTitle') },
  ];
    ...
    <div className="group mb-3">
      <div className="flex justify-between items-center mb-2">
        ...
        >
          ...
          >
            {t('editor.adjustments.basic.toneMapper')}
          </span>
          <span
            aria-hidden={!isLabelHovered}
          ...
          >
            {t('editor.adjustments.basic.reset')}
          </span>
        </div>
      </div>
      <div className="w-full p-2 pb-1 bg-card-active rounded-md">
        ...
        <div className="mt-2.5 px-1">
          <Slider
            label={t('editor.adjustments.basic.evShift')}
            max={5}
            min={-5}
...
export default function BasicAdjustments({
  ...
  return (
    <div>
      ...
      <Slider
        label={t('editor.adjustments.basic.exposure')}
        max={5}
        min={-5}
      ...
      />
      <Slider
        label={t('editor.adjustments.basic.contrast')}
        max={100}
        min={-100}
      ...
      />
      <Slider
        label={t('editor.adjustments.basic.whites')}
        max={100}
        min={-100}
      ...
      />
      <Slider
        label={t('editor.adjustments.basic.blacks')}
        max={100}
        min={-100}
