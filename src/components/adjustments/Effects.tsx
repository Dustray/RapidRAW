        ...
        <div className="space-y-4">
          ...
          {adjustmentVisibility.vignette !== false && (
            <div className="p-2 bg-bg-tertiary rounded-md">
              ...
              <Slider
                defaultValue={50}
                label={t('adjustments.effects.vignetteMidpoint')}
                max={100}
                min={0}
              ...
              />
              <Slider
                label={t('adjustments.effects.vignetteRoundness')}
                max={100}
                min={-100}
              ...
              <Slider
                defaultValue={50}
                label={t('adjustments.effects.vignetteFeather')}
                max={100}
                min={0}
          ...
          {adjustmentVisibility.grain !== false && (
            <div className="p-2 bg-bg-tertiary rounded-md">
              ...
              <Slider
                defaultValue={25}
                label={t('adjustments.effects.grainSize')}
                max={100}
                min={0}
              ...
              <Slider
                defaultValue={50}
                label={t('adjustments.effects.grainRoughness')}
                max={100}
                min={0}
